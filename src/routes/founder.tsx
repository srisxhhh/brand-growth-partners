            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-center">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  onClick={() => trackCalendarClick("Founder", "founder_profile")}
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 border border-foreground px-7 py-3.5 text-xs uppercase tracking-[0.2em] transition-colors hover:bg-foreground hover:text-background"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="18"
